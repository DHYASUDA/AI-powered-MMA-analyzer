error id: file:///C:/Users/david/techskill/demo/src/main/java/techskill/demo/Controller/mmaController.java:_empty_/chatAiService#
file:///C:/Users/david/techskill/demo/src/main/java/techskill/demo/Controller/mmaController.java
empty definition using pc, found symbol in pc: _empty_/chatAiService#
...
public class mmaController {
    ...
    public fightCard nextEvent(){
        return chatService.g@@etNextEventCard();
    }
}
```
