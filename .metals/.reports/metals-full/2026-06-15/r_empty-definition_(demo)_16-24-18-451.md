error id: file:///C:/Users/david/techskill/demo/src/main/java/techskill/demo/Controller/mmaController.java:_empty_/fighterName#
file:///C:/Users/david/techskill/demo/src/main/java/techskill/demo/Controller/mmaController.java
empty definition using pc, found symbol in pc: _empty_/fighterName#
...
public class mmaController{
        ...
        public List<JsonNode> fightDetails(@RequestParam("eventName") String eventName){
            ...
            System.out.println(mmaService.getUserEventDetailsByName(result));
            return mmaService.getUserEventDetailsByName(result);
        }

        @GetMapping("/searchFighter")
        public List<Map<String, Object>> getAllFighters() {
            return mmaService.searchFighter(fighterN@@ame);
        }
